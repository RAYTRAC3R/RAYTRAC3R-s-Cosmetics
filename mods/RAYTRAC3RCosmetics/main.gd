...
var colors = [ "black", "blue", "brown", "green", "grey", "maroon", "mint", "olive", "orange", "periwinkle", "pink", "purple", "red", "salmon", "silver", "sprout", "tan", "teal", "yellow", "zea" ] #stone is temporarily removed for being too close to silver and just adding clutter, same with west and olive, midnight and black
