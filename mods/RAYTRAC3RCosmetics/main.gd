...
var colors = [ "black", "blue", "brown", "green", "grey", "maroon", "mint", "olive", "orange", "periwinkle", "pink", "purple", "red", "salmon", "silver", "sprout", "tan", "teal", "yellow", "white", "zea" ] #stone is temporarily removed for being too close to silver and just adding clutter, same with west and olive, midnight and black
...
func _ready():
	...
	Lure.assign_pattern_texture(ID, ID + ".pattern_heartchest", "Zea.Species.species_axolotl", "res://mods/RAYTRAC3RCosmetics/Assets/Textures/heartchest/axolotl.png")
